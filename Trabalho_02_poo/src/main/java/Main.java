...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Profissional tecnicoEq     = new Profissional("Julia Ferreira", "TEC-555", TipoProfissional.TECNICO_EQUIPAMENTO);
        ...
        rem1.setVeiculoDesignado(ambUTI);
        ...
        rem2.setVeiculoDesignado(ambSimples);
        ...
        operacoes.stream()
                .sorted(Comparator.comparingInt(OperacaoClinica::calcularPrioridade).reversed())
                .forEach(op -> System.out.printf("  [Prioridade %2d] %s — %s%n",
        ...
        remTeste.cancelar();  // erro: já cancelada... na verdade cancelar não verifica CANCELADA, mas vamos testar concluída
    }
